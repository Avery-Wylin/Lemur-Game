...
void DebugDraw::draw( View &view ) {
    ...
    line_vao.loadAttributeByte( ATTRB_COL, 0, 0, 3, point_count, true, col );
    line_vao.loadAttributeFloat( ATTRB_POS, 0, 0, 3, point_count, pos );
    line_vao.loadIndex( index_count, indicies );
    line_vao.bind();
